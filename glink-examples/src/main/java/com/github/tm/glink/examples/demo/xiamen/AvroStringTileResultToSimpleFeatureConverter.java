...
import com.github.tm.glink.connector.geomesa.sink.TileResultToSimpleFeatureConverter;
...
/**
 * 将{@link TileResult}的信息使用Avro序列化，并以Base64的方式编码，转换为对应结构的SimpleFeature。
 * <p>SimpleFeature无几何信息，只有</p>
 *
